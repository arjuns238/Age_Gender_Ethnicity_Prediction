...
gender_model = model((48, 48, 1), 2, 'categorical_crossentropy')
...
gender_model_new.save( "gender_model_new")
age_model_new.save("age_model_new")
ethnicity_model_new.save("ethnicity_model_new")


# In[10]:


gender_model.save("gender_model_new_1")
